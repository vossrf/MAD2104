...
def DrawRelation(lab,S1,r1,S2,r2=[],S3=[],f=None,a=None,size=None):
    "create diagram of relation r1 (and optionally r2) as lists of arrow ends, lab list of left, arrow, right"
    global ax,fig
    if size is not None: plt.rcParams['figure.figsize'] = size
    setFigAx(f,a)        
...
def DiGraph(connects,prt=0,dir=1,rotate=0.0,nodemult=1.0,order=[],nodeXY=[],f=None,a=None,size=None,**kwargs):
